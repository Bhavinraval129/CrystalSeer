...
export const metadata = {
  title: "Our Story & Rituals | Crystal Seer",
  description: "Learn about Crystal Seer's commitment to ethical mineral sourcing, full moon cleansing rituals, and spiritual authenticity.",
};
    ...
    <div className="min-h-screen pt-32 pb-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8" style={{ background: "linear-gradient(180deg, #ffffff 0%, #fdfafc 40%, #f8f1f8 100%)" }}>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
        <div className="space-y-6">
          <h2 className="text-3xl font-playfair font-semibold text-deep-plum">The Crystal Seer Vision</h2>
          <p className="text-ink/80 leading-relaxed font-light text-sm">
            Crystal Seer was founded with a single mission: to create a transparent, high-vibrational sanctuary for spiritual seekers. We realized that many commercial crystal stores mass-produce stones under poor mining conditions, stripping the mineral of its natural healing essence.
          </p>
          <p className="text-ink/80 leading-relaxed font-light text-sm">
